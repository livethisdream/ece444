...
\begin{parts}
	...
	\part \textbf{(i)} A straight metal rod, split and fed at its center, roughly
	...
	its base.
		...
		is simple, resonant, easy to feed, and radiates in a donut around the wire,
	...
	curved metal dish with a small antenna suspended at its focus.
		...
		bag of aluminum. \textbf{(ii) Reflector (dish) antenna.} Its job is the
...
\begin{parts}
	...
	space.
		...
		traveling on a cable or in a waveguide, confined by conductors --- and a
		\textbf{radiating wave} traveling freely through space. It is the only
	...
	\part You measure a tracking antenna on transmit and find a $3\mydeg$
	...
	communications; navigation; tactical manpack radio and UHF SATCOM.
		...
		make a narrow beam. An HF antenna is tens of meters and a GPS patch is a few
		centimeters for exactly the same reason.
		\end{solution}
