...
patch elements on $d = 14\ \text{mm}$ centres and operates at $10.3\ \ghz$. Use
...
\begin{parts}
	...
	\part Turning off the outer four elements leaves the centre four running. State
...
\begin{parts}
	...
	\begin{minipage}[t]{0.58\linewidth}
		\part Find the aperture length required at broadside, in millimetres and in
		wavelengths.
		\begin{solution}[1.1in]
...
\begin{parts}
	...
	\begin{minipage}[t]{0.58\linewidth}
		...
		millimetres and the number of active elements on $14\ \text{mm}$ centres.
		\begin{solution}[1.2in]
	...
	\begin{minipage}[t]{0.58\linewidth}
		...
		\eq{ \theta_\text{HP} &= 27\mydeg = 0.471\ \text{rad} \\
		     ...
		     \approx 1.9\lambda }
		That is four elements at $14\ \text{mm}$ spacing, so the centre four are on
