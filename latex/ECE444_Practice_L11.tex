...
Take the aperture efficiency to be $\eta_{ap} = 0.65$ and
$c = 3\ee{8}\ \text{m/s}$.
...
\begin{parts}
	...
	the antenna amplifies.''
		...
		small that solid angle can be. Writing $G = \eta_{ap} 4\pi A /
	...
	\begin{minipage}[t]{0.58\linewidth}
		...
		\eq{
			...
			G &= \eta_{ap}\lp \frac{\pi D}{\lambda}\rp^{2}
			   = 0.65\,(60\pi)^{2} = 0.65\,(35531) \\
			  &= 2.31\ee{4}
			   \;\rightarrow\; 10\,\mylog{2.31\ee{4}} = 43.6\dbi
		}
		Remark: the effective aperture is $A_e = \eta_{ap}A =
...
\begin{parts}
	...
	\begin{minipage}[t]{0.58\linewidth}
		...
		\eq{
			...
			\eta_{surf} &= 10^{-0.069/10} = 0.984 \\
			\eta_{ap} &= (0.712)(0.984) = 0.700
		}
	...
	proposal.
		...
		\eq{
			...
			\eta_{surf} &= 10^{-0.171} = 0.674 \\
			\eta_{ap} &= (0.712)(0.674) = 0.48
		}
...
\begin{parts}
	...
	\begin{minipage}[t]{0.58\linewidth}
		...
		$\eta_{ap} = 0.75$ and elements on a $\lambda/2$ grid. How many
