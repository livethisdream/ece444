...
\begin{parts}
	...
	is it contributing?
		...
		centre elements (commanded to 100\%) is contributing nothing --- its
	...
	confirms your diagnosis.
		...
		\begin{solution}[1.0in]
		A dead centre element breaks the symmetry of the distribution, so the
...
40\% at the ends to 91\% at the centre:
