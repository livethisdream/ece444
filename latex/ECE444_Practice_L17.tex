...
\begin{parts}
	...
	\begin{minipage}[t]{0.58\linewidth}
		...
		The window is centered on the 2.2 GHz tuning. The offset of 225 MHz is 150 times
...
\begin{parts}
	...
	\begin{minipage}[t]{0.58\linewidth}
		\part The FFT peak sits $1\ \mhz$ above the center of the window. Find the IF of the
	...
	make, in order, and say what each one rules out.
		\begin{solution}[1.2in]
		First, confirm the HB100 is powered and aimed at the array from about a meter --
