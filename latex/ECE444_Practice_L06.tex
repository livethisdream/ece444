...
\begin{parts}
	...
	cosine-squared taper, triangular.
		\begin{solution}[1.3in]
		Uniform $\rightarrow -13.3\db$; cosine $\rightarrow -23\db$; triangular
		$\rightarrow -26.5\db$; cosine-squared $\rightarrow -31.5\db$. The smoother
		the distribution goes to zero at the edges, the less high-space-frequency
		content it has, and the lower the sidelobes.
		\end{solution}
