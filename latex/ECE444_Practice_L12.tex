...
\begin{parts}
	...
	does your answer imply about operating across a 350 kHz amateur band?
		\begin{solution}[1.2in]
		Yes. 10 kHz comfortably covers one 3 kHz voice channel, so the loop is usable on any
		single frequency. Moving elsewhere in a 350 kHz band means retuning the loop capacitor,
