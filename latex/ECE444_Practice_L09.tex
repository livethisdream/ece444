...
\begin{parts}
	...
	result.
		...
		system-level number, and quote the mismatch-corrected $32.3\dbi$
...
\begin{parts}
	...
	rests on.
		...
		assumption involved. The transform is the same relationship that produced the
		pattern in the first place, run in the other direction.
		\end{solution}
	...
	\begin{minipage}[t]{0.58\linewidth}
		...
		At a few points per second this is several hours of scanning, which is
		the principal cost of a near-field range.
		\end{solution}
	\end{minipage}\hfill%
	\begin{minipage}[t]{0.37\linewidth}
		\raggedleft \vspace{12pt}
