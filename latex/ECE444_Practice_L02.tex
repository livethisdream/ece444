...
beamwidth, and sidelobe level --- apply the reciprocity principle linking an
...
\begin{parts}
	...
	\part Front-to-back ratio (F/B), in dB.
		\begin{solution}[0.6in] Main lobe minus the level at $180\mydeg$; ``no distinct back lobe'' is acceptable with justification. The habit being built is reading pattern plots \emph{consistently} --- every later lesson reuses these same measurements. \end{solution}
\end{parts}
