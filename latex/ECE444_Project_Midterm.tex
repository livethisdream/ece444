...
\fullwidth{\textbf{Due \duedate.} Individual. Worth \projweight\ of the course
grade, assessed \textbf{Mastered / Not Yet Mastered}, with one resubmission
after feedback.}
...
\req{\textbf{This is the mastery bar.} You are not required to make the
...
\section{Mastered / Not Yet Mastered}

Mastered requires all of the following.

\begin{enumerate}[nosep]
	\item VSWR $\le$ 2 demonstrated at \fOne\ MHz by trimming and at $f_2$ by
	      matching, both with traces shown --- or, if a bar was missed, a
	      quantitative diagnosis of why.
	\item A balun built, and evidence in the report that it does something.
	\item The NEC prediction of $Z_a(f_2)$ presented, and presented as what the
	      match was designed against.
	\item Both instruments' traces of the final antenna, overlaid, with the
	      disagreement discussed.
	\item Co- and cross-polarized cuts in both planes at both frequencies, with
	      the measured floor stated as a number and drawn on the plots.
	\item Gain by comparison, with the reference antenna's own pattern
	      measured, and the validity conditions addressed.
	\item Every overlay's normalization basis declared.
	\item Every disagreement between predicted and measured either explained or
	      explicitly owned as unexplained.
	\item All required figures and tables present, typed, legible, captioned,
	      with data files.
\end{enumerate}

Not Yet Mastered is any required item missing --- and also a report in which
everything agrees, nothing is questioned, and no measurement appears to have
surprised its author.

You may revise and resubmit once after feedback.
...
Generative AI tools may be used for plotting, formatting, and debugging your
reduction code. They may not be used to produce your analysis, your
interpretation, or your prose. If you use them, say so in a short appendix
naming what you used them for.
