...
%
% L14 practice set (High-Gain Antennas) -- aperture gain and beamwidth, reflector
...
\begin{parts}
	...
	\begin{minipage}[t]{0.58\linewidth}
		...
		A half-millimeter surface is essentially free at C band.
		\end{solution}
	\end{minipage}\hfill%
	\begin{minipage}[t]{0.37\linewidth}
		\raggedleft \vspace{12pt}
...
\begin{parts}
	...
	helps. Why?
		...
		extends the slow forward traveling wave over a longer aperture. Gain
...
\begin{parts}
	...
	you just computed.
		\begin{solution}[1.4in]
		Take the dish. It is a single molded part 0.38\ \m\ across with one
