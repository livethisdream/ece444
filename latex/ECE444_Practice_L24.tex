...
\begin{parts}
	...
	\begin{minipage}[t]{0.58\linewidth}
		...
		\eq{ \theta_\text{HP} &= 1.20 \times 13.3\mydeg = 16.0\mydeg }
		\end{solution}
	\end{minipage}\hfill%
	\begin{minipage}[t]{0.37\linewidth}
		\raggedleft \vspace{12pt}
		$\theta_\text{HP}$ = \ansbox[1.2in]{$16.0\mydeg$}
	\end{minipage}
	...
	reaches a similar sidelobe level.
		...
		$2.7\mydeg$ wider, $0.48\db$ of directivity, and a $3.1\db$ lower peak on
...
\begin{parts}
	\begin{minipage}[t]{0.58\linewidth}
		...
		using $13.3\mydeg$ as the uniform reference.
		\begin{solution}[1.4in]
		\eq{ \sum a_n &= 2\lp 0.09 + 0.35 + 0.72 + 1.00 \rp = 4.32 \\
		\theta_\text{HP} &= 1.51 \times 13.3\mydeg = 20.1\mydeg \\
	...
	\begin{minipage}[t]{0.37\linewidth}
		\raggedleft \vspace{12pt}
		$\theta_\text{HP}$ = \ansbox[1.2in]{$20.1\mydeg$}
		\\[10pt]
