...
<h1 class="frame-title">Null Steering Theory</h1>
...
::::{frame} Part 1: When a null is worth more than gain
...
::::{frame} Anything loud, not just a jammer
...
::::{frame} The control we have not used yet
...
::::{frame} Part 2: Steering vectors are the language
...
::::{frame} The response is a dot product
...
::::{frame} Two conventions, both course-wide
...
::::{frame} Part 3: Deriving the weight-subtraction rule
...
::::{frame} Step 1 — build the beam that points at the interferer
...
::::{frame} Step 2 — subtract some of it
...
::::{frame} Step 3 — evaluate the response at the interferer
...
::::{frame} Step 5 — verify by substitution
...
::::{frame} Reading r_n: it is the pattern you already have
...
::::{frame} Main-lobe loss versus null angle
...
::::{frame} The weights ride a circle
...
::::{frame} Part 4: The PHASER example, end to end
...
::::{frame} Worked example, continued — the projection coefficient
...
::::{frame} Worked example, continued — the weights
...
::::{frame} Worked example, continued — the gain and phase table
...
::::{frame} Worked example, continued — the result
...
::::{frame} Small changes, easy to get wrong
...
::::{frame} Null steering on the 8-element PHASER array
:class: viz-frame
...
::::{frame} Part 5: What the null costs, and what limits it
...
::::{frame} The cost climbs as the null moves toward the beam
...
::::{frame} Quantization sets a floor on the depth
...
::::{frame} Halve the bits, lose six decibels of depth
...
::::{frame} What you can measure is shallower still
...
::::{frame} What the sweep can actually show
...
::::{frame} More nulls cost more degrees of freedom
...
::::{frame} Summary — the steering vectors and the rule
...
::::{frame} Summary — the cost of the null
...
::::{frame} Summary — the PHASER numbers
