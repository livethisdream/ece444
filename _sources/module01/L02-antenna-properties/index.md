...
<h1 class="frame-title">Basic Properties and Terminology</h1>
...
::::{frame} Maxwell's equations (source-free, linear media)
...
::::{frame} The Telegrapher's Equations
...
::::{frame} Both give you the wave equation
...
::::{frame} Impedance of free space and the far-field structure
...
::::{frame} The time-average Poynting vector
For a time-harmonic field we almost always
...
::::{frame} Power density in the far field
...
::::{frame} Directivity — the pencil-beam approximation
...
::::{frame} Γ, VSWR, and Power Reflected
...
::::{frame} Power as fractions of the incident power
...
::::{frame} Beamwidth, boresight, and lobes
...
::::{frame} Reciprocity — the same antenna, both ways
...
::::{frame} Why we care
Two payoffs. First, you can characterize an antenna in
...
::::{frame} Effective aperture — capturing an incident wave
...
::::{frame} Example: a short dipole
**Do it for the simplest antenna — an infinitesimal (Hertzian) dipole
...
:::{depth}
A practical center-fed short
dipole carries a *triangular* current instead, which halves both:
$\ell_e = \ell/2$ and $R_{\text{rad}} = 20\pi^{2}(\ell/\lambda)^{2}$ — the
ratio below, and therefore $A_e$, comes out the same.
:::
::::

::::{frame} Divide, and watch the ℓ's cancel
The incident power
...
::::{frame} Recognize the number
That $1.5$ is exactly the short dipole's
...
**It's universal.** We computed only one antenna — but **reciprocity**
...
::::{frame} Physical vs. effective aperture
An antenna with a real opening of area
...
::::{frame} Physical vs. effective aperture — dish, horn, and dipole
...
::::{frame} Worked example — gain and captured power of a 1.2 m dish
...
::::{frame} A subtlety worth pinning down
People often say "effective aperture shrinks
...
::::{frame} The Friis transmission equation
...
::::{frame} The Friis transmission equation — combining the two
...
::::{frame} Three things to read off it
...
::::{frame} Worked example — a 2.4 GHz satellite uplink budget
...
::::{frame} Summary — wave and power quantities
...
::::{frame} Summary — directivity, gain, and pattern
| Symbol / idea | What it is | Number to remember |
| :-- | :-- | :-- |
...
::::{frame} Summary — aperture and reciprocity
| Symbol / idea | What it is | Number to remember |
| :-- | :-- | :-- |
...
- <a class="doc-link" href="../../practice/ECE444_L02_Practice_blank.pdf" target="_blank" rel="noopener">Problem set (PDF)</a>
- <a class="doc-link doc-key" href="../../practice/ECE444_L02_Practice_SOLUTIONS.pdf" target="_blank" rel="noopener">Solutions (PDF)</a>
::::
