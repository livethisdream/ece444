...
::::{frame} Part 1: What you predicted, and what the sweep plot is
...
::::{frame} The prediction you bring
...
::::{frame} Two ways to measure a pattern
...
::::{frame} 1. Confirm the source on the FFT tab

Place the HB100 at boresight
...
::::{frame} 2. Move the source to the test angle

Slide the tripod along the arc to
...
::::{frame} 3. Hunt for the peak

In **Beam Steering**, enter a Steer Angle and press
...
::::{frame} 4. Read back the phases

With the peak command still applied, open the
...
::::{frame} 5. Sweep and compare

Switch to the **Rectangular** tab and press **Start**.
...
::::{frame} Two beam-sweep traces, source at boresight and at plus 30 degrees
...
::::{frame} 6. Record against the expected numbers

The table below is what the trace
...
::::{frame} 6. Record against the expected numbers, continued
...
::::{frame} Where the scan-loss number comes from
...
::::{frame} Part 4: Where the error comes from
...
::::{frame} Sweep-grid discretization

The sweep visits commanded angles on a
...
::::{frame} Protractor and aiming error

At a range of $1\ \text{m}$, one degree of arc is
...
::::{frame} HB100 frequency drift

The GUI computes phases from an assumed frequency. If
...
::::{frame} Multipath in the room

The bench, the walls, and the people standing nearby
...
::::{frame} The four error sources, sized
...
::::{frame} Table A — commanded versus physical angle

For three source positions,
...
::::{frame} Table B — phase check at $30^\circ$

All eight elements: your predicted
...
::::{frame} Summary — sidelobe and accuracy
...
- <a class="doc-link" href="../../practice/ECE444_L19_Practice_blank.pdf" target="_blank" rel="noopener">Problem set (PDF)</a>
- <a class="doc-link doc-key" href="../../practice/ECE444_L19_Practice_SOLUTIONS.pdf" target="_blank" rel="noopener">Solutions (PDF)</a>
::::
...
The midterm project, the antenna pattern measurement assigned at Lesson 9, is due
