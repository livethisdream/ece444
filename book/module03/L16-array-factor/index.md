...
::::{frame} Step 2 — path becomes phase
...
::::{frame} Step 5 — collect the phases
...
::::{frame} Anatomy: main lobe and nulls
...
::::{frame} Reading the closed form — main lobe and nulls
...
::::{frame} Reading the closed form — beamwidth and sidelobes
...
::::{frame} Worked example — four short dipoles, continued
...
::::{frame} Interactive — the array factor builder
:class: viz-frame
...
::::{frame} The grating-lobe criterion
...
::::{frame} The array as a sampled aperture
...
::::{frame} Worked example — the course array, continued
