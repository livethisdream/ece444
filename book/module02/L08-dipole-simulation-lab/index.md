...
### From segment currents to one input impedance
...
**Step 1 — Predict.** Before running anything, write down what Lesson 7 says
...
**Step 3 — Baseline run.** Run the file from Part 3 at 915 MHz and record
