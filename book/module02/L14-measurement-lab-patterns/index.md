...
::::{frame} Part 2: Equipment and range setup
...
::::{frame} Any hardware that logs power per angle works
...
::::{frame} Your bench range for this lab
...
::::{frame} Worked example — is 3.0 m far enough?
...
::::{frame} Worked example — is 3.0 m far enough?, continued

:::{admonition} Worked example — is 3.0 m far enough? (continued)
:class: tip
...
::::{frame} Match the heights with a tape, not by eye
...
::::{frame} Procedure — step size and the noise floor
...
::::{frame} Procedure — sweep both planes, then repeat one
...
::::{frame} Procedure — gain comparison and polarization
...
::::{frame} Rotate the source, not the AUT
...
::::{frame} Part 4: Reduction — getting numbers out
...
::::{frame} Four things to extract from the shape
...
::::{frame} Four things to extract from the shape, continued
...
::::{frame} Worked example — one E-plane cut, reduced
...
::::{frame} Worked example — one E-plane cut, reduced, continued

:::{admonition} Worked example — one E-plane cut, reduced (continued)
:class: tip
...
::::{frame} Worked example — gain and XPD
...
::::{frame} Worked example — gain and XPD, continued

:::{admonition} Worked example — gain and XPD (continued)
:class: tip
...
::::{frame} Part 5: Dynamic range — how much of your pattern is real
...
::::{frame} This lab's dynamic range is 42.4 dB
...
::::{frame} Watch the noise floor eat into a measured pattern
:class: viz-frame
...
The floor is the hard limit; these are the everyday errors, and each leaves a recognizable signature in the data.
...
::::{frame} Uncertainty budget, continued
