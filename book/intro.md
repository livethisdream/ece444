<script>
  ...
  document.title = "ECE 444 — Antennas, Phased Arrays, and Radar Systems";
</script>

<section class="hero">
  <p class="hero-eyebrow">USAFA · Dept. of Electrical &amp; Computer Engineering · ECE 444 · Fall 2026</p>
  <h1 class="hero-title">Antennas, Phased Arrays, and Radar Systems</h1>
  <p class="hero-lede">From Maxwell's equations to a working radar. Five modules, 40 lessons, and a capstone that puts hardware in your hands and a moving target in your sights.</p>
  <div class="hero-cta">
